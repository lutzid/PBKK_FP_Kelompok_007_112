...
{% block content %}
	<div class="row justify-content-center">
		<div class="col-md">
			<form method="POST" action="{{ url('/dashboard/kost/update') }}" enctype="multipart/form-data">
				...
				<div class="card col-md-8 offset-md-2">
					<div class="card-body">
						<div class="form-group row">
							...
							<div class="col-md-6">
								<input id="nama" type="text" class="form-control" name="nama" required autocomplete="nama" autofocus value="{{ kost.nama }}">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-6">
								<input id="alamat" type="text" class="form-control" name="alamat" required autocomplete="alamat" autofocus value="{{ kost.alamat }}">
							</div>
						</div>
